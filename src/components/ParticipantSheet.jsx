...
export function ParticipantSheet({ participant, onClose, onEdit, onSaveTemplate, onTracker, onDeleteTracker, onAddStatus, onRemoveStatus, onNote }) {
