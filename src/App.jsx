...
export default function App() {
  ...
  const resetClock = (participantId, trackerId) => actions.trackerChange(participantId, trackerId, { ...scene.participants.find((p) => p.id === participantId).trackers.find((t) => t.id === trackerId), current: 0 });
