    ...
    scenes: [
      {
        ...
        reserveNotes: 'Notes hors initiative de démo : le plan du lieu est incomplet, le contact paniqué peut revenir dans l’action, et une issue secondaire reste non vérifiée.',
      ...
      { id: 'bal', title: 'Bal masqué', type: 'Social', round: 1, activeId: 'elise', reserveOpen: true, notes: 'Scène sociale plus légère pour tester les changements de scène.', reserveNotes: '', globalTracker: { enabled: false, name: 'Influence', mode: 'counter', current: 0, max: 10, auto: false }, reserve: [], participants: [{ id: 'elise', name: 'Élise aux Cent Visages', kind: 'PJ', symbol: '🔮', color: 'violet', initiative: 12, description: 'Spécialiste des faux-semblants.', stats: ['Social 4'], statuses: [{ id: 'mask', name: 'Masquée', duration: null, remaining: null, loop: false, expired: false }], trackers: [{ id: 'stress', type: 'bar', name: 'Stress', visible: true, current: 18, min: 0, max: 40, step: 5, minAbsolute: true, maxAbsolute: false }, { id: 'faveurs', type: 'dots', name: 'Faveurs', visible: true, current: 2, max: 5 }] }] },
      { id: 'crypte', title: 'Crypte mécanique', type: 'Piège', round: 1, activeId: 'nora', reserveOpen: true, notes: 'Dalles gravées et engrenages derrière les murs.', reserveNotes: '', globalTracker: { enabled: true, name: 'Pression', mode: 'counter', current: 2, max: 10, auto: false }, reserve: [{ id: 'mecanisme', name: 'Mécanisme dormant', kind: 'Horloge', symbol: '⚙', color: 'amber', initiative: 1, description: 'Réserve avec horloge.', stats: [], statuses: [], trackers: [{ id: 'gear-clock', type: 'clock', name: 'Réveil', visible: true, current: 2, max: 4, auto: false }] }], participants: [{ id: 'nora', name: 'Nora Main-Sûre', kind: 'PJ', symbol: '🗝', color: 'blue', initiative: 11, description: 'Voleuse prudente.', stats: ['Crochetage 5'], statuses: [], trackers: [{ id: 'outils', type: 'dots', name: 'Outils', visible: true, current: 3, max: 3 }, { id: 'piege', type: 'clock', name: 'Piège', visible: true, current: 3, max: 4, auto: true }] }] },
    ],
  };
}
