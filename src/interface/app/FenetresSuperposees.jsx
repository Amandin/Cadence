...
export function FenetresSuperposees({ scene, restorePoints, dark, characters, templates, actions, etatInterface, commandesInterface, compteurGlobal, resolutionHorloge, templatesUi }) {
  ...
  return <>
    ...
    {characters.statusTarget && <FenetreEtat participant={characters.statusTarget} defaultAdvanceOn={allowActivationAutomation ? 'activation' : 'round'} afficherChoixEvolution={allowActivationAutomation} allowActivationAdvance={allowActivationAutomation} statusTemplates={statusTemplates} onFermer={characters.cancelStatus} onValider={characters.saveStatus} />}
