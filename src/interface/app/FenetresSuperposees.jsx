...
export function FenetresSuperposees({ scene, restorePoints, dark, themeState, onThemeModeChange, characters, templates, actions, etatInterface, commandesInterface, compteurGlobal, resolutionHorloge, templatesUi }) {
  const { addSheetOpen, openMenu, notice, globalSheetOpen, clockModalOpen, initiativeEntryOpen, initiativeEntryScopeIds, initiativeEntryInitialLaunch, creneauxManuelsActifs = isManualMultipleActionMode(scene) } = etatInterface;
  ...
  const optionsInitiative = { initiativeTextOrder: scene.initiativeTextOrder, multipleActionSlots: rulesAllowMultipleSlots(scene) };
