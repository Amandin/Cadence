...
export function FenetresSuperposees({ scene, restorePoints, dark, characters, templates, actions, etatInterface, commandesInterface, compteurGlobal, resolutionHorloge, templatesUi }) {
  ...
  return <>
    ...
    {characters.statusTarget && <FenetreEtat participant={characters.statusTarget} statusTemplates={statusTemplates} onFermer={characters.cancelStatus} onValider={characters.saveStatus} />}
    ...
    {characters.initiativeEditParticipant && <FenetreModificationInitiative participant={characters.initiativeEditParticipant} initiativeTextOrder={scene.initiativeTextOrder} onFermer={characters.cancelInitiativeEdit} onValider={characters.saveInitiativeEdit} />}
