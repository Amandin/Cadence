...
export function FenetreEditionFiche({ participant, initiativeTextOrder, phaseActionMode, phaseCount = defaultPhaseCount, multipleActionSlots = true, utiliserInitiative = true, categoryOrder = participantKinds, tiebreakerVisible = true, tiebreakerLabel = 'Departage', trackerTemplates = [], title = 'Modifier', saveTemplateVisible = true, deleteLabel = 'Supprimer la fiche', onClose, onSave, onDelete, onSaveTemplate }) {
  const textConfig = normalizeInitiativeTextOrder(initiativeTextOrder);
