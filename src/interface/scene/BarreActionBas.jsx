export function BarreActionBas({ classeSuivant, prochainRound, round, horlogeBloquee, suivantDesactive, libelleSuivant, onTourPrecedent, onTourSuivant, onAjouterPersonnage, onOuvrirMenu }) {
