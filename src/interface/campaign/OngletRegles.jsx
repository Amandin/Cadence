...
function OptionsBonusInitiativeCampagne({ scene, onModifier }) {
...
export function OngletRegles({ scene, rulePresetSnapshot, onModifierRegles, ruleTemplates, onAppliquerTemplateRegles, onEnregistrerTemplateRegles, onSupprimerTemplateRegles }) {
  ...
  return <div className="stack hub-section panel rules-panel"><div><h3>{t('rules.title')}</h3><p className="muted compact-help">{t('rules.help')}</p></div><OptionsTemplatesReglesCampagne scene={scene} ruleTemplates={ruleTemplates} rulePresetSnapshot={rulePresetSnapshot} dernierTemplateId={dernierTemplateId} nomCourant={nomCourant} editionNom={editionNom} sauvegardeOk={sauvegardeOk} onChangerNom={setNomCourant} onEditerNom={() => setEditionNom(true)} onFermerEditionNom={() => setEditionNom(false)} onAppliquer={appliquerTemplate} onEnregistrer={enregistrerTemplate} onSupprimer={onSupprimerTemplateRegles} /><ResumeReglesActives scene={scene} /><GroupeRegles titre={t('rules.group.development')} aide={t('rules.group.developmentHelp')}><OptionsTemporaliteCampagne scene={scene} temporalite={temporalite} availability={availability} onModifier={onModifierRegles} />{temporalite === temporalityModes.PHASES && <OptionsPhasesCampagne scene={scene} availability={availability} onModifier={onModifierRegles} />}<OptionsSurpriseCampagne scene={scene} availability={availability.surpriseAdvanceOn} onModifier={onModifierRegles} /></GroupeRegles><GroupeRegles titre={t('rules.group.initiative')} aide={t('rules.group.initiativeHelp')}>{initiativeActive && <OptionsInitiativeTextuelleCampagne scene={scene} availability={availability.labelInitiative} onModifier={onModifierRegles} onConfigurer={() => setInitiativeTextuelleOuverte(true)} />}<OptionsOrdreInitiativeCampagne scene={scene} onModifier={onModifierRegles} />{initiativeActive && <OptionsBonusInitiativeCampagne scene={scene} onModifier={onModifierRegles} />}{initiativeActive && <OptionsDepartageCampagne scene={scene} onModifier={onModifierRegles} />}<OptionsActionsMultiplesCampagne scene={scene} availability={availability.multipleActionSlots} onModifier={onModifierRegles} /><OptionsDeclarationCampagne scene={scene} availability={availability.declarationMode} onModifier={onModifierRegles} />{relanceInitiativeVisible && <OptionsRelanceInitiativeCampagne scene={scene} onModifier={onModifierRegles} />}</GroupeRegles><GroupeRegles titre={initiativeActive ? t('rules.group.equalities') : t('rules.group.organization')} aide={initiativeActive ? t('rules.group.equalitiesHelp') : t('rules.group.organizationHelp')}>{initiativeActive && <OptionsEgalitesCampagne scene={scene} onModifier={onModifierRegles} />}<OptionsOrdreCategoriesCampagne scene={scene} onModifier={onModifierRegles} /></GroupeRegles>{initiativeTextuelleOuverte && <FenetreInitiativeTextuelleEdition config={scene?.initiativeTextOrder} onFermer={() => setInitiativeTextuelleOuverte(false)} onValider={validerInitiativeTextuelle} />}</div>;
}
