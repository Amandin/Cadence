...
export function OngletRegles({ scene, rulePresetSnapshot, onModifierRegles, ruleTemplates, initiativeTextPresets = [], cardSources = [], rollDefinitions = [], embedded = false, onAppliquerTemplateRegles, onEnregistrerTemplateRegles, onEnregistrerPresetInitiativeTextuelle, onSupprimerTemplateRegles }) {
