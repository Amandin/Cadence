...
La routine `test:uiux` parcourt maintenant 14 scénarios en deux largeurs, 390 × 844 et 1440 × 900. Elle couvre :
...
- scénarios : 14 ;
- surfaces observées : 94 ;
- actions automatisées : 88 / 88 OK ;
